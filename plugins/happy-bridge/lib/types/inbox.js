 ...
 */
export function uniqueInboxName(taken, name) {
 ...
 */
export function inboxReadPath(filename) {
 ...
 */
export function inboxReadPrompt(text, relativePaths) {
 ...
 */
export async function saveInboxFiles(cwd, files) {
    if (files.length === 0)
        return [];
