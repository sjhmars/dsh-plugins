...
import { addProfilePlugin, INSTALLER_PACKAGE, entryBelongsToPackage, parseNpmPackageName, resolveInstallAnchor, resolveInstalledPackageUrl, } from "./add.js";
export { parseNpmPackageName, addProfilePlugin, entryBelongsToPackage, isInstallProfile, INSTALL_PROFILES, INSTALLER_PACKAGE, } from "./add.js";
/** Cordis 插件名。 */
export const name = 'plugin-install';
/** 非法 profile 名在加载时失败。 */
export const Config = Schema.object({
    profile: Schema.union([Schema.const('web'), Schema.const('desktop')]).default('web'),
});
